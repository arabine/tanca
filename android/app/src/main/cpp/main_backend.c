...
Java_eu_d8s_Tanca_MainActivity_stringFromJNI( JNIEnv* env, jobject thiz )
{
#if defined(__arm__)
...
Java_eu_d8s_Tanca_MainActivity_startTicks(JNIEnv *env, jobject instance) {
 ...
 */
JNIEXPORT void JNICALL
Java_eu_d8s_Tanca_MainActivity_StopTicks(JNIEnv *env, jobject instance) {
