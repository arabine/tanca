	...
	*/
	function drawGame(ctx, round, position, t1, t2) {
...
define([], function() {
	...
	Brackets.prototype.draw = function (gameString)
	{
		 ...
		 if (Array.isArray(gameList)) {
			 ...
			 //    console.log(position);
			  //   console.log(gameList[i].t1.name);
				 drawGame(ctx, gameList[i].round, position, gameList[i].t1, gameList[i].t2);
